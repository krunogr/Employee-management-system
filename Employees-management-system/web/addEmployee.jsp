            ...
            <div id="insertdata">
                <form method="POST" name="forma" >
                    <table style="margin-left: 200px">
                        ...
                        <tr >
                            <td colspan="2" style=" text-align:center;"> <input type="submit" value="Save employee"/></td>
                        </tr>
                            <tr >
                        </tr>
                ...
                <c:if test="${pageContext.request.method=='POST'}">
                    <sql:update dataSource="${con}" var="forma">INSERT INTO employees ( `name`, `surname`, `years_of_experience`, `department`) VALUES( '<c:out value="${param.name}"/>', '<c:out value="${param.surname}"/>', '<c:out value="${param.years_of_experience}"/>', '<c:out value="${param.department}"/>')</sql:update>
                    <p style="margin-left: 250px">  New employee is added!</p>
                </c:if> 
            </div>
        </div>
    </body>
